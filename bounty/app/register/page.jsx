...
import { Lock, Mail, Eye, EyeOff, Shield, AlertCircle, UserPlus } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center px-4">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Join the CTF platform and start learning</p>
        </div>
        ...
        >
          ...
          <div className="mt-6 p-4 bg-blue-500/10 border border-blue-500/30 rounded-lg">
            <p className="text-xs text-blue-300">
              ...
              This is a vulnerable application designed for learning security concepts.
            </p>
          </div>
        </motion.div>
